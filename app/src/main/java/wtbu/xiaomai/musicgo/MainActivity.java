...
import wtbu.xiaomai.musicgo.service.MusicService;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MusicService musicControl;
    ...
    private class MyServiceConn implements ServiceConnection {  //用于实现连接服务
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            musicControl = myBinder.getService();
            musicControl.setMusicUri(uri);
            //musicControl = (MusicService) service;
        }
        @Override
