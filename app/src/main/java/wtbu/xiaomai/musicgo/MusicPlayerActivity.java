        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_next:
                    ...
                    break;
                case R.id.back_btn:
                    Toast.makeText(MusicPlayerActivity.this,"you click back",
                            Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(MusicPlayerActivity.this,MusicInformationActivity.class);
...
/**
 * i gotta count count count count this cash i made today
 * if u ain't talking about money then it is not a damn thing
 * i got cash cash cash cash they running to my bank
 * if u ain't gonna take my cash then u wont have ur fame
 *
 * */